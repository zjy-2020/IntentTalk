"""Shared optimization and decoding loop for the IntentTalk generator."""
...
from utils.intenttalk_components import build_intenttalk_joint_context, load_pretrained_vq_suite
...
class GenerationTrainer(train.TrainingRuntime):
    def __init__(self, args):
        ...
        joint_context = build_intenttalk_joint_context(self.args.ori_joints)
