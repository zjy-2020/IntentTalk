...
if __package__ is None or __package__ == "":
    # executed as a script: add project root (IntentTalk) into sys.path
    THIS_FILE = pathlib.Path(__file__).resolve()
    PROJECT_ROOT = THIS_FILE.parents[1]   # .../IntentTalk
...
from dataloaders.intenttalk_preprocess_common import PickleDataset, PreprocessProcessor, write_pickle
...
def main():
    ...
    # 改为 pkl 目标路径
    ap.add_argument("--dst_pkl", default="./datasets/beat2_intenttalk_test.pkl" ,help="Destination pickle file")
